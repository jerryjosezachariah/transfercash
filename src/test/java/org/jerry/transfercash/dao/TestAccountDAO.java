...
public class TestAccountDAO extends TestService{
	...
	@Test
	public void testGetAccountsByUserName() throws CustomException {
		List<Account> accounts = h2DaoFactory.getAccountDAO().getAccountsByUserName("Harry Potter");
		assertTrue(accounts.get(0).getUserName().equals("Harry Potter"));
	}

	@Test
	public void testGetNonExistingAccByUserName() throws CustomException {
		List<Account> accounts = h2DaoFactory.getAccountDAO().getAccountsByUserName("Non existing user");
