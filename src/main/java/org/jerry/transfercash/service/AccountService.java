...
public class AccountService {
    ...
    public List<Account> getAccountsByUserName(@PathParam("userName") String userName) throws CustomException {
        return daoFactory.getAccountDAO().getAccountsByUserName(userName);
    }
